...
public class App {
    ...
    public static void main(String[] args) {
        ...
        List<String> files = Arrays.asList(
                customerService.getCustomerFilePath(),
                productService.getPRODUCT_FILE_PATH(),
                orderService.getORDER_FILE_PATH());

        entityIDService.prepareInitialFiles(files);
...
//        System.out.println(orderService.getOrdersByDate(1999, 10, 31));
